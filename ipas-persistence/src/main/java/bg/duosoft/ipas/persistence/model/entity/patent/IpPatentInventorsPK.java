...
import bg.duosoft.ipas.persistence.model.entity.IntellectualPropertyRelatedPersonPK;
import lombok.*;
...
@EqualsAndHashCode
@Embeddable
public class IpPatentInventorsPK implements Serializable, IntellectualPropertyRelatedPersonPK {
