...
@NoArgsConstructor
@AllArgsConstructor
public class InternationalMarkFilter implements Sortable, Pageable {
    private String sortOrder = this.ASC_ORDER;
    private String sortColumn = InternationalMarkSorterUtils.REGISTRATION_NUMBER;
    private Integer page = this.DEFAULT_PAGE;
    private Integer pageSize = this.DEFAULT_PAGE_SIZE;
    private String gazno;
    private Boolean withoutDivided = false;
}
