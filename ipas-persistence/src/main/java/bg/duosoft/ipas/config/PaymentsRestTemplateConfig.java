...
public class PaymentsRestTemplateConfig {
    ...
    public RestTemplate paymentsRestTemplate() {
        String username = propertyAccess.getPaymentRestServiceUsername();
        String password = propertyAccess.getPaymentRestServicePassword();
        String restServiceURL = propertyAccess.getPaymentRestServiceUrl();
        try {
