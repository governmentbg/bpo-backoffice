...
@Configuration
public class EfUserChangeRestTemplateConfig {

    @Autowired
    private PropertyAccess propertyAccess;

    @Bean
    public RestTemplate esUserChangeRestTemplate() {
        String username = propertyAccess.getEfuserchangeUsername();
        String password = propertyAccess.getEfuserchangePassword();
        String restServiceURL = propertyAccess.getEfuserchangeUrl();
        try {
