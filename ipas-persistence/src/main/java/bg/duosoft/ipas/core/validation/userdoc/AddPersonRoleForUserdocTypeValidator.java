...
@Component
public class AddPersonRoleForUserdocTypeValidator implements IpasValidator<String> {
    ...
    public List<ValidationError> validate(String userdocType, Object... additionalArgs) {
        ...
        if (userdocType == null) {
            result.add(ValidationError.builder().pointer("userdoc.type.role.add").messageCode("missing.userdoc.type").build());
        }
        if (role == null) {
            result.add(ValidationError.builder().pointer("userdoc.type.role.add").messageCode("missing.role").build());
        }
        ...
        if (cUserdocType == null) {
            ...
            if (cUserdocPersonRole == null) {
                ...
                if (cUserdocType.getRoles().contains(cUserdocPersonRole)) {
                    result.add(ValidationError.builder().pointer("userdoc.type.role.add").messageCode("role.already.exist").build());
                }
            }
        }
