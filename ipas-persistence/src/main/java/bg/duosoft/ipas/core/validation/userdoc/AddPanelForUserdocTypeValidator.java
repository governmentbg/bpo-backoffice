...
@Component
public class AddPanelForUserdocTypeValidator implements IpasValidator<String> {
    ...
    public List<ValidationError> validate(String userdocType, Object... additionalArgs) {
        ...
        if (userdocType == null) {
            result.add(ValidationError.builder().pointer("userdoc.type.panel.add").messageCode("missing.userdoc.type").build());
        }
        if (panel == null) {
            result.add(ValidationError.builder().pointer("userdoc.type.panel.add").messageCode("missing.panel").build());
        }
        ...
        if (cUserdocType == null) {
            ...
            if (cUserdocPanel == null) {
                ...
                if (cUserdocType.getPanels().contains(cUserdocPanel)) {
                    result.add(ValidationError.builder().pointer("userdoc.type.panel.add").messageCode("panel.already.exist").build());
                }
            }
        }
