...
--changeset mmihova:305.1
drop procedure [IPASPROD].[deleteUserdocDetails];

--changeset mmihova:305.2 splitStatements:false
...
BEGIN
    ...
    delete FROM EXT_CORE.IP_INTERNATIONAL_NICE_CLASSES WHERE DOC_ORI = @docOri and DOC_LOG = @docLog and DOC_SER = @docSer and DOC_NBR = @docNbr;
