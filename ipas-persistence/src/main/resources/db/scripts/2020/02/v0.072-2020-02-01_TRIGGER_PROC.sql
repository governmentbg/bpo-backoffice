...
/****** Object:  Trigger [PROC_INDEX_AFTER]    Script Date: 03/02/2020 1:18:14 PM ******/
DROP TRIGGER [IPASPROD].[PROC_INDEX_AFTER]
;

/****** Object:  Trigger [IPASPROD].[PROC_INDEX_AFTER]    Script Date: 03/02/2020 1:18:14 PM ******/
SET ANSI_NULLS ON
;
...
--changeset vnikolov:72.2 splitStatements:false
