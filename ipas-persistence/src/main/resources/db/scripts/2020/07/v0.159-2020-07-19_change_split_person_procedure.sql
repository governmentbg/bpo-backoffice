...
--changeset dveizov:159.1
DROP PROCEDURE IPASPROD.splitIpPerson
;
--changeset dveizov:159.2 splitStatements:false
...
BEGIN
    BEGIN TRY
        BEGIN TRANSACTION
            ...
            EXEC replaceIpPerson @oldPersonNumber = @personNumber, @oldAddressNumber = @addressNumber, @newPersonNumber = @newPersonNumber, @newAddressNumber = @newAddressNumber
        COMMIT TRANSACTION
    END TRY
    BEGIN CATCH
        DECLARE
