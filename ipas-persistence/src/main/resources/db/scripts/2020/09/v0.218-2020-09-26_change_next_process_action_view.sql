...
--changeset dveizov:218.1
DROP VIEW VW_SELECT_NEXT_PROCESS_ACTIONS;

--changeset dveizov:218.2 splitStatements:false
...
select a.ACTION_TYP,
       ...
       (CASE WHEN a.DUE_DATE_CALCULATION_WCODE IS NULL AND s.IND_TRIGGER_END_FREEZE='S'  THEN 1 ELSE 0 END)         as CALCULATE_TERM_FROM_ACTION_DATE,
...
select a.ACTION_TYP,
       ...
       (CASE WHEN a.DUE_DATE_CALCULATION_WCODE = 6 THEN 1 ELSE 0 END)                                                as CONTAIN_MANUAL_DUE_DATE,
       (CASE WHEN a.DUE_DATE_CALCULATION_WCODE IS NULL AND s2.IND_TRIGGER_END_FREEZE='S'  THEN 1 ELSE 0 END)         as CALCULATE_TERM_FROM_ACTION_DATE,
       (CASE WHEN m.OFFIDOC_TYP IS NOT NULL THEN m.OFFIDOC_TYP ELSE null END)                                        as GENERATED_OFFIDOC,
       m.PROC_TYP                                                                                                    as PROC_TYP,
...
select a.ACTION_TYP,
       ...
       (CASE WHEN a.DUE_DATE_CALCULATION_WCODE = 6 THEN 1 ELSE 0 END) as CONTAIN_MANUAL_DUE_DATE,
       0                                                              as CALCULATE_TERM_FROM_ACTION_DATE,
