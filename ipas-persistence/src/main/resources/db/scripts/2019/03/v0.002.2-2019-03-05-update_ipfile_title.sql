CREATE TRIGGER [IPASPROD].[SOLICITUD_UPDATE_AFTER_INSERT] ON [IPASPROD].[IP_PATENT]
AFTER INSERT
	AS
	SET NOCOUNT ON
...
ALTER TABLE [IPASPROD].[IP_PATENT] ENABLE TRIGGER [SOLICITUD_UPDATE_AFTER_INSERT];
