...
--changeset vnikolov:27.1 splitStatements:false
/************************************************ TYPES ********************************************************/
/*
0 - not present
1 - patent
...
/*************************************************** [IPASPROD].[MARK_OWNER_INDEX_AFTER] ********************************************************************/
CREATE TRIGGER [IPASPROD].[MARK_OWNER_INDEX_AFTER]
...
ALTER TABLE [IPASPROD].[IP_MARK_OWNERS] ENABLE TRIGGER [MARK_OWNER_INDEX_AFTER]
;


--liquibase formatted sql

--changeset vnikolov:27.2 splitStatements:false

/*************************************************** [IPASPROD].[[MARK_REPRS_INDEX_AFTER]] ********************************************************************/
CREATE TRIGGER [IPASPROD].[MARK_REPRS_INDEX_AFTER]
...
ALTER TABLE [IPASPROD].[IP_MARK_REPRS] ENABLE TRIGGER [MARK_REPRS_INDEX_AFTER]
;
