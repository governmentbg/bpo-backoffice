package com.duosoft.ipas.ui.utilitymodel;
...
@Ignore
public class UtilityModeSearchPageTest extends ConfigurationUiTest {

    @Test
    public void testUntitledTestCase() {

        driver.get(baseUrl + "/utility_model/search");
        authorization();

        // Title
        assertEquals("Търсене на полезен модел", driver.getTitle());
        ...
        assertEquals("Търсене на полезен модел", driver.findElement(By.xpath("//*[@id=\"breadcrumbs\"]/ol/li[2]/span")).getText() );
