package com.duosoft.ipas.ui.eupatent;
...
@Ignore
public class EuPatentSearchPageTest extends ConfigurationUiTest {

    @Test
    public void testUntitledTestCase() {

        driver.get(baseUrl + "/eupatent/search");
        authorization();

        // Title
        assertEquals("Търсене на европейски патент", driver.getTitle());
        ...
        assertEquals("Търсене на европейски патент", driver.findElement(By.xpath("//*[@id=\"breadcrumbs\"]/ol/li[2]/span")).getText() );
        ...
        assertEquals("Искане за валидиране", driver.findElement(By.xpath("//*[@id=\"detail-list\"]/li[16]/span")).getText());
