package com.duosoft.ipas.ui.mark;
...
@Ignore
public class MarkSearchPageTest extends ConfigurationUiTest {

    @Test
    public void testUntitledTestCase() {

        driver.get(baseUrl + "/mark/search");
        authorization();

        // Title
        assertEquals("Търсене на търговски марки", driver.getTitle());
        ...
        assertEquals("Търсене на търговски марки", driver.findElement(By.xpath("//*[@id=\"breadcrumbs\"]/ol/li[2]/span")).getText() );
        ...
        assertEquals("Вид марка", driver.findElement(By.xpath("//*[@id=\"detail-list\"]/li[2]/span")).getText());
        ...
        assertEquals("Ница класове", driver.findElement(By.xpath("//*[@id=\"detail-list\"]/li[14]/span")).getText());
        assertEquals("Виена класове", driver.findElement(By.xpath("//*[@id=\"detail-list\"]/li[15]/span")).getText());
