package com.duosoft.ipas.ui.spc;
...
@Ignore
public class SpcSearchPageTest extends ConfigurationUiTest {
    ...
    public void testUntitledTestCase() {
        ...
        driver.get(baseUrl + "/spc/search");
        authorization();

        // Title
        assertEquals("Търсене на сертификат за допълнителна закрила (SPC)", driver.getTitle());
        ...
        assertEquals("Търсене на сертификат за допълнителна закрила (SPC)", driver.findElement(By.xpath("//*[@id=\"breadcrumbs\"]/ol/li[2]/span")).getText() );
        ...
        js.executeScript("document.getElementById(\"psb\").scrollTop = document.getElementById(\"psb\").scrollHeight;");

        assertEquals("Разрешение за пускане на пазара в България: номер", driver.findElement(By.xpath("//*[@id=\"detail-list\"]/li[16]/span")).getText());
        assertEquals("Разрешение за пускане на пазара в България: дата", driver.findElement(By.xpath("//*[@id=\"detail-list\"]/li[17]/span")).getText());
        assertEquals("Разрешение за пускане на пазара в Общността: номер", driver.findElement(By.xpath("//*[@id=\"detail-list\"]/li[18]/span")).getText());
        assertEquals("Разрешение за пускане на пазара в Общността: дата", driver.findElement(By.xpath("//*[@id=\"detail-list\"]/li[19]/span")).getText());
