...
public class UtilityModelController extends PatentLikeController {
    @Autowired
    ...
    public boolean isValidFileType(String fileType) {
        return FileType.UTILITY_MODEL.code().equals(fileType);
    }

    @Override
    public String getViewPage() {
        return "ipobjects/patentlike/utilitymodel/view";
    }
