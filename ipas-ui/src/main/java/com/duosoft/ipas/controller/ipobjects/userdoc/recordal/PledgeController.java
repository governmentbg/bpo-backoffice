...
@Slf4j
@Controller
@RequestMapping("/userdoc/pledge")
public class PledgeController extends ExtraDataBaseController {

    @Override
    public String getPanelPage() {
        return "ipobjects/userdoc/recordal/pledge/pledge_panel :: pledge";
    }
