...
@Slf4j
@Controller
@RequestMapping("/userdoc/withdrawal")
public class WithdrawalController extends ExtraDataBaseController {
    ...
    public String getPanelPage() {
        return "ipobjects/userdoc/recordal/withdrawal/withdrawal_panel :: withdrawal";
    }
