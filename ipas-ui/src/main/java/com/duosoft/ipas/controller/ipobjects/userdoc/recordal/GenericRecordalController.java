...
@Slf4j
@Controller
@RequestMapping("/userdoc/generic-recordal")
public class GenericRecordalController extends ExtraDataBaseController {
    ...
    public String getPanelPage() {
        return "ipobjects/userdoc/recordal/generic_recordal/generic_recordal_panel :: generic_recordal";
    }
}
