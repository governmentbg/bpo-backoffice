...
@Slf4j
@Controller
@RequestMapping("/userdoc/license")
public class LicenseController extends ExtraDataBaseController {
    ...
    public String getPanelPage() {
        return "ipobjects/userdoc/recordal/license/license_panel :: license";
    }
